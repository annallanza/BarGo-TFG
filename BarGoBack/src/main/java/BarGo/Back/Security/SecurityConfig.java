    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        */
        ...
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/usuaris/solicitarCanviarContrasenya").permitAll() //la url que conte email, es acceccible per a tothom
                .antMatchers("/usuaris/canviarContrasenya").permitAll() //la url que conte email, es acceccible per a tothom
